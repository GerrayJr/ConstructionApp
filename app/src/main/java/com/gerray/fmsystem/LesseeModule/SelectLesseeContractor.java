...
public class SelectLesseeContractor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plumbAdapter = new FirebaseRecyclerAdapter<CreateContractor, ConsultantViewHolder>(options) {
            ...
            public ConsultantViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                return new ConsultantViewHolder(LayoutInflater.from(SelectLesseeContractor.this).inflate(R.layout.consultants_cards, parent, false));
            }
        };
    ...
    public void selectContractor(String consultantID) {
        ...
        LesseeDetailsClass lesseeDetailsClass = new LesseeDetailsClass(workID, userID, null, null, workDate, description, status, consultantID, null, imageUrl);
        ...
        startActivity(new Intent(SelectLesseeContractor.this, LesseeActivity.class));
